    ...
    <div className="flex justify-center mobile:flex-col mobile:mt-4 mobile:p-3">
        ...
        <div className="flex-[1.3] flex flex-col items-start  justify-items-center mt-10 mobile:items-center">
          ...
          <div className="flex flex-col place-self-start">
            ...
            Couleurs
            <select className="border-[2px] border-silver rounded-md ml-5" onChange={(e) => setColor(e.target.value)}>
            ...
            <div className="mt-7 text-2xl">
             Taille
             <select className="border-[2px] border-silver rounded-md ml-5" onChange={(e) => setSize(e.target.value)}>
           <option>select</option>
            {Product.size?.map((s) => (
